...
class EDMSampling:
    def __init__(self, p_mean=-1.2, p_std=1.2, num_frames=25, num_cameras=6):
        self.p_mean = p_mean
        self.p_std = p_std
    ...
    def __call__(self, n_samples, rand=None):
        bs = n_samples // self.num_frames // self.num_cameras
        rand_init = torch.randn((bs, self.num_cameras))
        rand_init = repeat(rand_init, "b v -> (b v t)", v=self.num_cameras, t=self.num_frames)
