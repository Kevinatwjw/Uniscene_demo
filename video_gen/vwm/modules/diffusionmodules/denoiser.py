...
class Denoiser(nn.Module):
    ...
    def forward(
        self, network: nn.Module, noised_input: torch.Tensor, sigma: torch.Tensor, cond: Dict, cond_mask: torch.Tensor
    ):
        ...
        # import pdb; pdb.set_trace()  ## cond.keys()  (['crossattn', 'vector', 'concat'])
