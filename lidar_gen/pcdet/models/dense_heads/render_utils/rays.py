...
class RayBundle(nn.Module):
    ...
    def __init__(
        self, origins, directions, depths=None, nears=None, fars=None, **kwargs
    ):
    ...
    def get_ray_samples(
        ...
        frustums = Frustums(
            origins=self.origins[..., None, :].expand(broadcast_size),
            directions=self.directions[..., None, :].expand(broadcast_size),
            starts=bin_starts,
            ends=bin_ends,
        )
