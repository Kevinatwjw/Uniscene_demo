...
import numpy as np
from .neus_v3 import NeuSModelV3, conv_bn_relu, BasicBlock
...
class NeuSModelV5Upsample(NeuSModelV3):
    def __init__(
        self,
        pc_range,
        voxel_size,
        ...
        **kwargs
        ...
        self.rgb_upsampler = torch.nn.Sequential(
            ...
            conv_bn_relu(rgb_hidden_dim, rgb_hidden_dim, kernel_size=3, padding=1, use_bn=True),
