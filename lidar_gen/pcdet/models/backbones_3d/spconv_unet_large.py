...
class UNetV2Large(nn.Module):
    ...
    def __init__(self, model_cfg, input_channels, grid_size, voxel_size, point_cloud_range, **kwargs):
        ...
        self.inv_conv3 = block(128, 128, 3, norm_fn=norm_fn, indice_key='spconv3', conv_type='inverseconv')

        # [1600, 1408, 41] <- [800, 704, 21]
        self.conv_up_t2 = SparseBasicBlock(64, 64, indice_key='subm2', norm_fn=norm_fn)
        self.conv_up_m2 = block(192, 96, 3, norm_fn=norm_fn, indice_key='subm2')
        self.inv_conv2 = block(96, 96, 3, norm_fn=norm_fn, indice_key='spconv2', conv_type='inverseconv')
