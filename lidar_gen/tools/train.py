...
def parse_config():
    ...
    parser.add_argument("-w", "--work_dir", type=str, default=WORK_DIR, help="work dir to save log and ckpt")
    parser.add_argument("--lr", type=str, default=None, required=False, help="set learning rate")
    parser.add_argument("--batch_size", type=int, default=None, required=False, help="batch size for training")
    parser.add_argument("--epochs", type=int, default=None, required=False, help="number of epochs to train for")
    parser.add_argument("--workers", type=int, default=4, help="number of workers for dataloader")
    parser.add_argument("--extra_tag", type=str, default="default", help="extra tag for this experiment")
    parser.add_argument("--ckpt", type=str, default=None, help="checkpoint to start from")
    parser.add_argument("--pretrained_model", type=str, default=PRETRAINED, help="pretrained_model")
